...
from .http_config import HTTPConfig, HTTP_POST, HTTP_GET, HTTP_PUT, HTTP_DELETE
...
class HTTPConnection:
    ...
    def execute(self, *, data: dict = None) -> requests.Response:
        """

        :param data: JSON encoded payload
        :return:
        """
        params = {"url": self.http_config.url, "headers": self.http_config.headers, "verify": True}
